    ...
    return (
        <div className="container mx-auto px-12 py-8 flex flex-col md:flex-row justify-evenly">
            <div className='flex flex-col max-w-md'>
                ...
                <p className='font-medium text-gray-700 text-center md:text-left'>Ante cualquier consulta, sugerencia, solicitud de presupuesto,
                ...
                <div className='md:flex flex-wrap justify-evenly hidden'>
                    ...
                    <p className='flex items-end font-medium text-xs text-gray-700 w-1/2 text-left ml-4 tracking-wide'>
                        Además puede comunicrse a través de nuestra línea telefónica al +54 11 4775-5115 (Lun-vie: 8.30-17.30hs) o por mail a ventas@caxer.com.ar.
                    </p>
                </div>
            </div>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`mt-1 p-2 w-full border rounded-sm ${errors.nombre ? 'border-cyan-500' : ''}`}
                        />
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`mt-1 p-2 w-full border rounded-sm ${errors.apellido ? 'border-cyan-500' : ''}`}
                        />
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        className={`mt-1 p-2 w-full border rounded-sm ${errors.telefono ? 'border-cyan-500' : ''}`}
                    />
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        className={`mt-1 p-2 w-full border rounded-sm ${errors.email ? 'border-cyan-500' : ''}`}
                    />
                ...
                <div className="mb-4">
                    ...
                    <textarea
                        ...
                        rows="4"
                        className={`mt-1 p-2 w-full border rounded-sm ${errors.mensaje ? 'border-cyan-500' : ''}`}
                    ></textarea>
