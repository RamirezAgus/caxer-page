            ...
            <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
                ...
                <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                    ...
                    <div className="w-44 pt-6 md:pt-0">
                        <Link to='/contacto' className="bg-cyan-500 hover:bg-cyan-600 transition justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">CONTACTANOS</Link>
                    </div>
                </div>
