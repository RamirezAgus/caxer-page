...
import logo7 from "../assets/logos/hyper-logo.png";
  ...
  return (
    <section className="w-full min-h-screen py-10">
      ...
      <div className="flex justify-center items-center pb-5">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-18 md:gap-x-14 lg:gap-40 items-center">
