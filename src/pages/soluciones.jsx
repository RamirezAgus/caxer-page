        ...
        <section className='container-lg'>
            <div className='w-full'>
                ...
                <DescriptionSolution
                    ...
                    items={[
                        { icon: MdOutlineMonitor, subtitle: 'Captura: ', description: 'De manera manual, o automática, desde un scanner, multifunción, email, unidades de red y web.' },
                        { icon: FaCog, subtitle: 'Procesa: ', description: 'Mejora de imagen, reconocimiento de caracteres (OCR) y codigos de barras, cambio de formatos de archivos.' },
                        { icon: FaPrint, subtitle: 'Enruta: ', description: 'Hacia carpetas compartidas, impresoras, email, y a la mayoría de los ECM del mercado.' }
                    ]}
                />
                ...
                <DescriptionSolution
                    ...
                    items={[
                        { icon: FaUnlock, subtitle: 'Accesos: ', description: 'Permite controlar quién tiene acceso al dispositivo, y de qué manera puede utilizarlo cada usuario (sólo blanco y negro, con máximo de 100 copias color, por ejemplo).' },
                        { icon: FaChartLine, subtitle: 'Reportes: ', description: 'Muestra diversidad de reportes con los gastos asociados a usuarios, departamentos, proyectos, etc.' },
                        { icon: MdOutlinePhoneIphone, subtitle: 'Folow you: ', description: 'Bajo el concepto “Follow you” las impresiones se liberan sólo a pedido del usuario, en cualquier dispositivo de la empresa.' }
                    ]}
                />
                <hr className="border-gray-400 w-2/3 flex items-center justify-center mx-auto" />
                <SectionSolution
                ...
                <DescriptionSolution
                    ...
                    items={[
                        { icon: IoIosDocument, subtitle: 'Administra: ', description: 'De manera manual, o automática, desde un scanner, multifunción, email, unidades de red y web.' },
                        { icon: FaSearch, subtitle: 'Contenidos: ', description: 'Mejora de imagen, reconocimiento de caracteres (OCR) y codigos de barras, cambio de formatos de archivos.' },
                        { icon: FiRefreshCw, subtitle: 'Versionado: ', description: 'Hacia carpetas compartidas, impresoras, email, y a la mayoría de los ECM del mercado.' }
                    ]}
                />
                <hr className="border-gray-400 w-2/3 flex items-center justify-center mx-auto" />
                <SectionSolution
